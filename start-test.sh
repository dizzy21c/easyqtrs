...
do 
  #echo $line
  python tdx_hcalc_new1.py -f tdx_lyqd,tdx_dqe_test_A01,tdx_dqe_xqc_A1 -b 2020-01-01 -e 2022-12-31 -r $line -t B -a all -s 0,0,50
  #python tdx_hcalc_new1.py -f tdx_sxp,tdx_dqe_xqc_A1 -b 2020-01-01 -e 2022-12-31 -r $line -t B -a all -s 0,0,50
...
#python tdx_hcalc_new1.py -f tdx_sxp,tdx_dqe_xqc_A1 -b 2020-01-01 -e 2022-12-31 -r 2022-11-02 -t B -a all -s 0,0,50
