...
from custom.qqdataengine import TencentEngine
#import pymongo
#import redis
# choose = input('1: \n:')
...
class DataEngine(TencentEngine):
    EventType = 'data-engine'
    PushInterval = 60
    # config = "stock_list"
    mongo = MongoIo()
    # market = 'sh'  or 'sz'
...
#     EventType = 'block-engine'
#     PushInterval = 8
#     config = "bk_list"

class IndexEngine(SinaEngine):
    EventType = 'index-engine'
    PushInterval = 10
    config = "index2_list"
...
# qe_list=[data_engine, IndexEngine, WorkerEngine]
qe_list=[DataEngine, IndexEngine]
